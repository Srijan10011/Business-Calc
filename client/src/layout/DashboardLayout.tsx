...
// Derive the props type directly from the component to avoid import issues
    ...
    <ThemeProvider theme={mdTheme}>
      <Box sx={{ display: 'flex' }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          >
            <Typography component="h2" variant="h6" color="inherit" noWrap sx={{ mr: 'auto', ml: 2}}>Logo</Typography>
