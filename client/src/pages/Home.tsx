...
import { Typography, Button, Container, Box, AppBar, Toolbar } from '@mui/material';
        ...
        <>
            ...
            <Container maxWidth="sm">
                ...
                >
                    ...
                    <Box sx={{ mt: 4 }}>
                        <Button variant="contained" color="primary" component={RouterLink} to="/register" sx={{ mr: 2 }}>
                            Get Started
                        </Button>
