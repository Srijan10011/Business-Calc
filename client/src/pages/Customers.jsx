...
function createData(id, name, phone, address, // Added address
totalPurchases, outstandingCredit, lastPurchase) {
    return { id, name, phone, address, totalPurchases, outstandingCredit, lastPurchase };
}

const rows = [
    createData('cust-001', 'John Smith', '+1 123 456 7890', '123 Main St, Anytown', // Placeholder address
    '₹25,000', '₹5,000', '13 Jan, 2026'),
    createData('cust-002', 'Jane Doe', '+1 987 654 3210', '456 Oak Ave, Somewhere', // Placeholder address
    '₹15,000', '₹0', '10 Jan, 2026'),
    createData('cust-003', 'ACME Corp', '+1 555 123 4567', '789 Pine Ln, Nowhere', // Placeholder address
    '₹125,000', '₹10,000', '05 Jan, 2026'),
    createData('cust-004', 'Tech Solutions', '+1 222 333 4444', '101 Elm Blvd, Anyplace', // Placeholder address
    '₹80,000', '₹2,000', '01 Jan, 2026'),
];
