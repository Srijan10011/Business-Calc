...
router.post('/', authMiddleware, loadPermissions, requirePermission('team.manage'), addTeamMember);
router.post('/salary-payout', authMiddleware, loadPermissions, requirePermission('team.manage'), payoutSalary);
router.post('/distribute-salary', authMiddleware, loadPermissions, requirePermission('team.manage'), distributeSalary);
router.post('/auto-distribute', authMiddleware, loadPermissions, requirePermission('team.manage'), autoDistributeSalaries);
router.put('/:id', authMiddleware, loadPermissions, requirePermission('team.manage'), updateTeamMember);
