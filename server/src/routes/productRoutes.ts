...
router.post('/', authMiddleware, loadUserBusiness, loadPermissions, requirePermission('products.create'), addProduct);
router.get('/', authMiddleware, loadUserBusiness, loadPermissions, requirePermission('products.view'), getProducts);
router.get('/:id', authMiddleware, loadUserBusiness, loadPermissions, requirePermission('products.view'), getProductById);
router.post('/add-stock', authMiddleware, loadUserBusiness, loadPermissions, requirePermission('products.edit'), addStock);
router.delete('/:id', authMiddleware, loadUserBusiness, loadPermissions, requirePermission('products.delete'), async (req: any, res: any) => {
    const { id } = req.params;
