...
CREATE TABLE public.cost_categories (
    ...
    monthly_target numeric(14,2) DEFAULT NULL::numeric
);
...
--
-- Name: COLUMN cost_categories.is_recurring; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON COLUMN public.cost_categories.is_recurring IS 'True for monthly recurring costs (rent, interest), false for one-time assets';


--
-- Name: COLUMN cost_categories.monthly_target; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON COLUMN public.cost_categories.monthly_target IS 'Monthly target amount to recover for recurring costs';
...
--
-- Name: monthly_cost_recovery; Type: TABLE; Schema: public; Owner: srijanacharya22
--

CREATE TABLE public.monthly_cost_recovery (
    recovery_id uuid DEFAULT gen_random_uuid() NOT NULL,
    ...
    CONSTRAINT monthly_cost_recovery_status_check CHECK (((status)::text = ANY ((ARRAY['in_progress'::character varying, 'fulfilled'::character varying, 'unfulfilled'::character varying])::text[])))
);


ALTER TABLE public.monthly_cost_recovery OWNER TO srijanacharya22;

--
-- Name: TABLE monthly_cost_recovery; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON TABLE public.monthly_cost_recovery IS 'Tracks monthly recovery progress for recurring fixed costs like rent and loan interest';
...
--
-- Name: refresh_tokens; Type: TABLE; Schema: public; Owner: srijanacharya22
--
...
ALTER TABLE public.refresh_tokens OWNER TO srijanacharya22;

--
-- Name: TABLE refresh_tokens; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON TABLE public.refresh_tokens IS 'Stores hashed refresh tokens for session management and revocation';


--
-- Name: COLUMN refresh_tokens.token_hash; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON COLUMN public.refresh_tokens.token_hash IS 'Bcrypt hash of the refresh token - never store plain tokens';


--
-- Name: COLUMN refresh_tokens.expires_at; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON COLUMN public.refresh_tokens.expires_at IS 'Token expiration time - 7 days from creation';


--
-- Name: COLUMN refresh_tokens.last_used; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON COLUMN public.refresh_tokens.last_used IS 'Last time this token was used to refresh access token';


--
-- Name: COLUMN refresh_tokens.ip_address; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON COLUMN public.refresh_tokens.ip_address IS 'IP address where token was created for security audit';


--
-- Name: COLUMN refresh_tokens.user_agent; Type: COMMENT; Schema: public; Owner: srijanacharya22
--

COMMENT ON COLUMN public.refresh_tokens.user_agent IS 'Browser or device info for security audit';
...
--
-- Name: monthly_cost_recovery monthly_cost_recovery_pkey; Type: CONSTRAINT; Schema: public; Owner: srijanacharya22
--

ALTER TABLE ONLY public.monthly_cost_recovery
    ADD CONSTRAINT monthly_cost_recovery_pkey PRIMARY KEY (recovery_id);
...
--
-- Name: refresh_tokens refresh_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: monthly_cost_recovery unique_category_month; Type: CONSTRAINT; Schema: public; Owner: srijanacharya22
--

ALTER TABLE ONLY public.monthly_cost_recovery
    ADD CONSTRAINT unique_category_month UNIQUE (category_id, month);
...
--
-- Name: idx_business_account_account_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_account_account_id ON public.business_account USING btree (account_id);


--
-- Name: idx_business_account_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_account_business_id ON public.business_account USING btree (business_id);


--
-- Name: idx_business_account_composite; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_account_composite ON public.business_account USING btree (account_id, business_id);


--
-- Name: idx_business_customers_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_customers_business_id ON public.business_customers USING btree (business_id);


--
-- Name: idx_business_customers_customer_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_customers_customer_id ON public.business_customers USING btree (customer_id);


--
-- Name: idx_business_inventory_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_inventory_business_id ON public.business_inventory USING btree (business_id);


--
-- Name: idx_business_inventory_inventory_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_inventory_inventory_id ON public.business_inventory USING btree (inventory_id);


--
-- Name: idx_business_transactions_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_transactions_business_id ON public.business_transactions USING btree (business_id);


--
-- Name: idx_business_transactions_transaction_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_business_transactions_transaction_id ON public.business_transactions USING btree (transaction_id);


--
-- Name: idx_business_users_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_business_users_user_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_cogs_account_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_cogs_account_business_id ON public.cogs_account USING btree (business_id);


--
-- Name: idx_cogs_account_category_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_cogs_account_category_id ON public.cogs_account USING btree (category_id);


--
-- Name: idx_cogs_account_composite; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_cogs_account_composite ON public.cogs_account USING btree (category_id, business_id);


--
-- Name: idx_cost_categories_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_cost_categories_business_id ON public.cost_categories USING btree (business_id);


--
-- Name: idx_cost_categories_type; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_cost_categories_type ON public.cost_categories USING btree (type);


--
-- Name: idx_credit_payables_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_credit_payables_business_id ON public.credit_payables USING btree (business_id);


--
-- Name: idx_credit_payables_party_name; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_credit_payables_party_name ON public.credit_payables USING btree (business_id, party_name);


--
-- Name: idx_credit_payables_status; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_credit_payables_status ON public.credit_payables USING btree (status);


--
-- Name: idx_debit_account_customer_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_debit_account_customer_id ON public.debit_account USING btree (customer_id);


--
-- Name: idx_debit_account_sale_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_debit_account_sale_id ON public.debit_account USING btree (sale_id);


--
-- Name: idx_debit_account_status; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_debit_account_status ON public.debit_account USING btree (status);


--
-- Name: idx_inventory_logs_created_at; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_inventory_logs_inventory_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_monthly_recovery_business; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_monthly_recovery_business ON public.monthly_cost_recovery USING btree (business_id);


--
-- Name: idx_monthly_recovery_category; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_monthly_recovery_category ON public.monthly_cost_recovery USING btree (category_id);


--
-- Name: idx_monthly_recovery_month; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_monthly_recovery_month ON public.monthly_cost_recovery USING btree (month);


--
-- Name: idx_monthly_recovery_status; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_monthly_recovery_status ON public.monthly_cost_recovery USING btree (status);


--
-- Name: idx_payments_created_at; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_payments_customer_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_payments_sale_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_product_cost_allocation_category_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_product_cost_allocation_category_id ON public.product_cost_allocation USING btree (category_id);


--
-- Name: idx_product_cost_allocation_product_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_product_cost_allocation_product_id ON public.product_cost_allocation USING btree (product_id);


--
-- Name: idx_products_business_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_products_business_business_id ON public.products_business USING btree (business_id);


--
-- Name: idx_products_business_product_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_products_business_product_id ON public.products_business USING btree (product_id);


--
-- Name: idx_refresh_tokens_expires; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_refresh_tokens_token_hash; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_refresh_tokens_user_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_sales_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_sales_customer_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_sales_info_created_at; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_sales_info_created_at ON public.sales_info USING btree (created_at DESC);


--
-- Name: idx_sales_info_product_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_sales_info_product_id ON public.sales_info USING btree (product_id);


--
-- Name: idx_sales_info_status; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_sales_info_status ON public.sales_info USING btree (status);


--
-- Name: idx_sales_sale_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_sales_sale_id ON public.sales USING btree (sale_id);
...
--
-- Name: idx_transactions_account_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_transactions_created_at; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_transactions_type; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_user_requests_business_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--

CREATE INDEX idx_user_requests_business_id ON public.user_requests USING btree (business_id);


--
-- Name: idx_user_requests_status; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: idx_user_requests_user_id; Type: INDEX; Schema: public; Owner: srijanacharya22
--
...
--
-- Name: monthly_cost_recovery fk_monthly_recovery_business; Type: FK CONSTRAINT; Schema: public; Owner: srijanacharya22
--

ALTER TABLE ONLY public.monthly_cost_recovery
    ADD CONSTRAINT fk_monthly_recovery_business FOREIGN KEY (business_id) REFERENCES public.businesses(business_id) ON DELETE CASCADE;


--
-- Name: monthly_cost_recovery fk_monthly_recovery_category; Type: FK CONSTRAINT; Schema: public; Owner: srijanacharya22
--

ALTER TABLE ONLY public.monthly_cost_recovery
    ADD CONSTRAINT fk_monthly_recovery_category FOREIGN KEY (category_id) REFERENCES public.cost_categories(category_id) ON DELETE CASCADE;
...
--
-- Name: refresh_tokens refresh_tokens_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: srijanacharya22
--
